    ...
    <?php require_once("header2.php"); ?>
                ...
                <div class="whenLivraison">
                  <div class="btn-group" role="group">
                    ...
                    <ul :class="{ active: isDropdownVisible }" class="dropdown-menu" ref="dropdownMenu">
                        <li><a @click.prevent="setDeliveryOption('Livrer maintenant')" class="dropdown-item" href="#">Livrer immediatement</a></li>
        ...
        <div class="container_1">
           <div class="LivFoodPro">
            <div class="foodpro">
                <img src="images/burgerMc1.png" alt="foodpro">
                <h3>Envie de partager votre talent </h3>
                <a href="#">Ajouter votre restaurant</a>
            </div>
            <div class="platliv">
                <img src="images/burgerMc3.png" alt="platliv">   
                <h3>Laissez les réserver chez vous</h3>
                <a href="#">Reservez a votre choix</a>
            </div>
            <div class="livreur">
                <img src="images/LitalianoV2.png" alt="livreur">
